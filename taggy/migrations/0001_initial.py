...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('docfile', models.FileField(upload_to='json/%Y/%m/%d')),
            ],
        ),
        migrations.CreateModel(
            name='Emoticons',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postAnnotatorState', models.CharField(default='IN_PROGRESS', max_length=12)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('occupation', models.CharField(default=None, max_length=150)),
                ('biography', models.TextField(default=None)),
                ('diagnosis', models.CharField(default=None, max_length=100)),
                ('diagnosed', models.DateField(default=None)),
                ('recurrent', models.CharField(default=None, max_length=150)),
                ('metastatic', models.CharField(default=None, max_length=10)),
                ('stage', models.CharField(default=None, max_length=10)),
                ('lymph', models.CharField(default=None, max_length=10)),
                ('posLymphNodes', models.CharField(default=None, max_length=10)),
                ('tumorSize', models.CharField(default=None, max_length=20)),
                ('tumorGrade', models.CharField(default=None, max_length=30)),
                ('hormoneReceptor', models.CharField(default=None, max_length=100)),
                ('herStatus', models.CharField(default=None, max_length=100)),
            ],
            options={
