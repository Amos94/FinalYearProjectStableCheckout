...
class Tag:
    ...
    def render_in_table(self):
        toReturn = ''
        toReturn += "[" + self.name + "(" + self.provideOrRequest+ ")]"
        return toReturn
    ...
    def render_as_div(self, is_tagBtn = False, is_editable = True ):
        ...
        toReturn +="<div id='t"+ self.tagID+"' class='tag "+ kind+" "+is_editable +" "+tag_enumerated_class+" "+tag_provideOrRequest_class+" "+tag_enumerated_provideOrRequest_class+" '>"
        return toReturn
